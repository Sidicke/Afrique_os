const fs = require('fs');
let content = fs.readFileSync('src/components/marketplace/TrustBar.tsx', 'utf8');

const trustItemsStr = `  const TRUST_ITEMS = [
    {
      icon: (
...
fs.writeFileSync('src/components/marketplace/TrustBar.tsx', content);

...
// I must also change `/espace-admin/` back to `/espace-vendeur/` in `DashboardSidebar.tsx` because git checkout reverted it!!
sidebar = sidebar.replace(/\/espace-admin/g, '/espace-vendeur');

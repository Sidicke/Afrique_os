  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <Link
          href="/espace-admin/mes-boutiques/nouvelle"
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center gap-3 rounded-2xl border border-dashed border-line bg-surface p-12 text-center">
          ...
          <Link href="/espace-admin/mes-boutiques/nouvelle" className="mt-2 rounded-xl bg-blue-700 px-4 py-2 text-sm font-semibold text-white transition hover:bg-blue-800">
            Créer ma boutique
          </Link>
        </div>
      ) : (
              ...
              >
                ...
                <div className="flex flex-1 flex-col gap-3 p-4">
                  ...
                  <div className="mt-auto flex items-center gap-2">
                    ...
                    <Link
                      href={`/espace-admin/mes-boutiques/${b.id}`}

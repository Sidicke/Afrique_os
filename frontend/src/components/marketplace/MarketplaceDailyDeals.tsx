        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-6 gap-4 border-b border-line pb-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-1.5">
              <div className="bg-surface border border-line text-midnight-950 rounded-md w-8 h-8 flex items-center justify-center font-mono font-bold text-xs shadow-xs">
            ...
            products.map((product) => {
              ...
              return (
                <Link
                  ...
                  className="group bg-white rounded-3xl p-5 flex flex-col sm:flex-row gap-6 border border-midnight-950/8 hover:border-gold-400/50 hover:shadow-xl transition-all duration-300 relative overflow-hidden"
                >
                  {promo && (
                    ...
                    <div className="mt-auto">
                      <div className="flex items-center justify-between text-xs font-medium">
                        <span className="inline-flex items-center gap-1.5 text-ink-500">
                          ...
                          {product.boutique?.name ?? "Afrique Commerce"}
                        </span>
                        {product.rating ? (
